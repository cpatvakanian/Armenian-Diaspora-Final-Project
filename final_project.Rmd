...
# to bbe read as integers in order
...
```{r making sidebarpanel}

# here is where the problems come in my data, as I am
# having a lot of trouble trying to get data 
# to be detected by my sidebar object. I think
# there is an error caused by how I read this object
# in but I am not certain, any way the sidebar works
# locally but not when I publish :(

diasporas.df <- as.data.frame(diasporas)

save(diasporas.df,file="diasporas.df")

write_rds(diasporas, "diaspora_final_project/diasporas1.rds")
